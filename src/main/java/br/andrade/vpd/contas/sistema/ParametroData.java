package br.andrade.vpd.contas.sistema;
...
public class ParametroData {
	...
	public Pageable getPageable() {
		...
		Integer pagina = Integer.valueOf(getParametro(PAGINA));
		Integer limite = Integer.valueOf(getParametro(LIMITE));
	...
	/**
	 * No postmam estava dando problema para converter para o objeto ao ligar o
	 * front pode servir
	 * 
	 * @param objeto
	 * @param classe
	...
	public String toString() {
		return new ToStringBuilder(this).append(filtros).append(parametros).toString();
	}
